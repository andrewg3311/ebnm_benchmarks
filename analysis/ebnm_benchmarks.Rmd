...
The plots below detail the results of the simulation study. For each of $B = 100$ simulation repetitions, I simulate $n = 1000$ observations $x_j$ and standard errors $s_j$ from the normal means model.
