...
compare_res = function(res_list, true_par1, true_par2) {
  ...
  for (i in 1:n) {
    d = res_list[[1]][, par_names[1]]
    hist(d, xlab = paste("MLE Estimate for ", par_names[1], sep = ""), main = paste("Estimates for ", par_names[1], ": run ", unique(res_list[[1]]$name), sep = ""))
  }
  ...
  for (i in 1:n) {
    d = res_list[[1]][, par_names[2]]
    hist(d, xlab = paste("MLE Estimate for ", par_names[2], sep = ""), main = paste("Estimates for ", par_names[1], ": run ", unique(res_list[[1]]$name), sep = ""))
  }
}
```
